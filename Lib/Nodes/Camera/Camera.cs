...
using Fantoria.Lib.Nodes.Camera.Shifts;
using Godot;

namespace Fantoria.Lib.Nodes.Camera;
...
public partial class Camera : Camera2D
{
	...
	public Vector2 TargetPosition = Vec(); // Position where camera wants to be
	public Vector2 ActualPosition = Vec(); // Position where camera is currently in
	public Vector2 PositionShift = Vec(); // Additional shift to ActualPosition
	public Vector2 HardPositionShift = Vec(); // Additional shift to ActualPosition that will not be smoothed. Usable for shake
